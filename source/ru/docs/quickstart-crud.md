...
Теперь у нас есть возможность управлять записями блога (создавать, просматривать, редактировать и удалять). Не забудьте позаботиться об удобстве навигации, добавив пункты меню и хлебные крошки по материалу в "[Быстрый старт для начинающих](https://orchid.software/ru/docs/quickstart)".
